...
const SkillCard = ({ skill, index }) => (
  ...
  >
    ...
    <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-lg
      bg-white/[0.04] border border-white/[0.06] group-hover:border-primary1/20
  ...
  return (
    <button
      ...
      className={`relative flex flex-col items-start gap-2 p-4 rounded-2xl border
        text-left w-full transition-all duration-250
        ${isActive
    ...
    >
      {/* Accent symbol */}
      <span
        className="text-xl leading-none transition-opacity duration-250"
    ...
    <section className="px-4 py-16 sm:px-6 md:px-12 lg:px-10 md:py-24 lg:pt-32">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {/* ══ MOBILE / TABLET layout (< lg) ══
            2×2 category grid on top, skill grid below */}
        ...
        {/* ══ DESKTOP layout (lg+) ══
            Vertical sidebar + skills panel side by side */}
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center gap-3 px-4 py-3 rounded-xl border
                    text-sm font-medium text-left w-full transition-all duration-250
                    ${isActive
